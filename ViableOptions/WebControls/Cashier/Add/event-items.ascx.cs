...
public partial class WebControls_Cashier_Add_event_item : System.Web.UI.UserControl
{
    ...
    string ApplicationName = "Viable-Option Calendar";
    ...
    protected void cpForm_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
    {
        ...
        if (!cbStock.SelectedIndex.Equals(-1))
            available_stock = Int32.Parse(cbStock.SelectedItem.Value.ToString());
    ...
    protected void gvItems_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        ...
        try
        {
            ...
            {
                gvItems.JSProperties["cpMessage"] = "Payment already in process!!!";
            }
        }
        catch (Exception ex)
        {
    ...
    /*   protected void cbStock_Init(object sender, EventArgs e)
       {
