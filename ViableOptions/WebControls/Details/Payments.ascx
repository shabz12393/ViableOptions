...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Payments.ascx.cs" Inherits="WebControls_Details_Payments" %>



<div class="row mt-2">
    <dx:ASPxGridView ID="gvPayments" runat="server" AutoGenerateColumns="False" 
        ClientInstanceName="gvPayments" EnableRowsCache="False" EnableTheming="True" 
        Width="100%" KeyFieldName="payment_id">
        <SettingsAdaptivity AdaptivityMode="HideDataCellsWindowLimit" 
            HideDataCellsAtWindowInnerWidth="800" AllowOnlyOneAdaptiveDetailExpanded="true" AdaptiveDetailColumnCount="1">
        </SettingsAdaptivity>
        ...
        <Settings ShowFooter="True" ShowGroupFooter="VisibleAlways" VerticalScrollableHeight="250" 
            VerticalScrollBarMode="Visible" />
          <Columns>
            <dx:GridViewDataTextColumn FieldName="payment_id" ReadOnly="True" ShowInCustomizationForm="True" 
                VisibleIndex="9" Caption="payment id">
