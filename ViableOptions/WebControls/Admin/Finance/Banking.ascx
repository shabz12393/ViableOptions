            ...
            <ContentCollection>
                <dx:ContentControl runat="server">
                    <div class="w3-container">
                        ...
                        <div class="row mt-2">
                            <dx:ASPxGridView ID="gvBanking" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" DataSourceID="odsBanking" EnableRowsCache="False" EnableTheming="True" KeyFieldName="banking_id" Width="100%" OnCustomCallback="gvBanking_CustomCallback" OnRowInserting="gvBanking_RowInserting" OnRowUpdating="gvBanking_RowUpdating" OnRowDeleting="gvBanking_RowDeleting">
