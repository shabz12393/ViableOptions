<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Customers.ascx.cs" Inherits="WebControls_Admin_Reports_Customers" %>
...
<div class="style">
    <dx:ASPxWebDocumentViewer ID="wdvReport" runat="server" ColorScheme="dark" ReportSourceId="xrCustomer">
