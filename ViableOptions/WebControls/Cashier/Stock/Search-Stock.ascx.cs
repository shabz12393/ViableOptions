...
public partial class WebControls_Cashier_Stock_Search_Stock: System.Web.UI.UserControl
{
    ...
    protected void deDate_Init(object sender, EventArgs e)
    {
        deDate.Date = TimeUtils.getDate();
