<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Banking.ascx.cs" Inherits="WebControls_Cashier_Reports_Banking" %>
...
<div class="style">
    <dx:ASPxWebDocumentViewer ID="wdvReport" runat="server" ColorScheme="dark" ReportSourceId="xrBanking">
