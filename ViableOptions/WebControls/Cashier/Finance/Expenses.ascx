            ...
            <ContentCollection>
                <dx:ContentControl runat="server">
                    <div class="w3-container">
                        ...
                        <div class="row mt-2">
                            <dx:ASPxGridView ID="gvExpenses" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                                DataSourceID="odsExpenses" EnableRowsCache="False" EnableTheming="True" KeyFieldName="expense_id"
                                Width="100%" OnCustomCallback="gvExpenses_CustomCallback" OnRowInserting="gvExpenses_RowInserting"
                                OnInitNewRow="gvExpenses_InitNewRow">
