<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Expenses.ascx.cs" Inherits="WebControls_Cashier_Reports_Expenses" %>
...
<div class="style">
    <dx:ASPxWebDocumentViewer ID="wdvReport" runat="server" ReportSourceId="xrExpenses" ColorScheme="dark">
