<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Countries.ascx.cs" Inherits="WebControls_Control_Countries" %>
...
<div>
    <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Width="100%">
        <TabPages>
            <dx:TabPage Text="Country Management">
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <table class="style">
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxGridView ID="gvCountries" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" DataSourceID="odsCountries" EnableTheming="True" KeyFieldName="countryId" Width="100%" Font-Names="" OnCustomCallback="gvCountries_CustomCallback">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn FieldName="country_id" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="3">
                            ...
                            <tr>
                                <td>
                                    <asp:ObjectDataSource ID="odsCountries" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsMainTableAdapters.countryTableAdapter" DeleteMethod="Delete" InsertMethod="Insert" UpdateMethod="Update">
                                        <DeleteParameters>
