<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Event-Info.ascx.cs" Inherits="WebControls_Cashier_Bookings_Event_Info" %>
...
<div class="row">
    <dx:ASPxGridView ID="gvBookings" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvBookings"
        ...
        <SettingsAdaptivity AdaptivityMode="HideDataCellsWindowLimit" HideDataCellsAtWindowInnerWidth="300" AllowOnlyOneAdaptiveDetailExpanded="true" AdaptiveDetailColumnCount="1">
        </SettingsAdaptivity>
